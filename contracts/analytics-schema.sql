...
-- Status: binding. Sprint 4 reads it, Sprint 7 loads it.
-- =============================================================================
--
-- WHY A SECOND SCHEMA
--
-- The transactional schema you design in Sprint 3 is normalised so that a write
...
--
--   Snowflake   the target named in the curriculum. Use it if the cohort has
--               accounts.
...
--
-- Both fallbacks are acceptable in delivery and neither costs marks. What is
...
--             this show a five-day sawtooth that participants misread as a
--             trend.
